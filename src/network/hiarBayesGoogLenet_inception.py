...
class hiarBayesGoogLeNet:
    ...
    def build(width, height, depth, classes, pooling_regions = [1, 3], weights="imagenet"):
        ...
        fea_low = hiarBayesGoogLeNet.Inception(x, [128]*6, name="conv1_e_1")#512
        fea_low = hiarBayesGoogLeNet.Inception(fea_low, [128]*6, name="conv1_e_2")#512
        fea_low = hiarBayesGoogLeNet.Inception(fea_low, [132]*6, name="conv1_e_3")#528
        fea_low = hiarBayesGoogLeNet.Inception(fea_low, [208]*6, name="conv1_e_4")#832
        fea_low = hiarBayesGoogLeNet.Inception(fea_low, [256]*6, name="conv1_e_5")#1024
        ...
        fea_mid = hiarBayesGoogLeNet.Inception(x, [132]*6, name="conv2_e_3")#528
        fea_mid = hiarBayesGoogLeNet.Inception(fea_mid, [208]*6, name="conv2_e_4")#832
        fea_mid = hiarBayesGoogLeNet.Inception(fea_mid, [256]*6, name="conv2_e_5")#1024
        ...
        fea_hig = hiarBayesGoogLeNet.Inception(x, [256]*6, name="conv3_e_5")#1024
