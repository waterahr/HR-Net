...
class hiarGoogLeNet_high:
    ...
    def Inception(x, nb_filter, name=None):
        """
        branch1x1 = hiarGoogLeNet_high.Conv2d_BN(x, nb_filter, (1,1), padding='same', strides=(1,1), name=None)
     
        branch3x3 = hiarGoogLeNet_high.Conv2d_BN(x, nb_filter, (1,1), padding='same', strides=(1,1), name=None)
        branch3x3 = hiarGoogLeNet_high.Conv2d_BN(branch3x3, nb_filter,(3,3), padding='same', strides=(1,1), name=None)
     
        branch5x5 = hiarGoogLeNet_high.Conv2d_BN(x, nb_filter, (1,1), padding='same', strides=(1,1),name=None)
        branch5x5 = hiarGoogLeNet_high.Conv2d_BN(branch5x5, nb_filter, (1,1), padding='same', strides=(1,1), name=None)
     
        branchpool = MaxPooling2D(pool_size=(3,3), strides=(1,1), padding='same')(x)
        branchpool = hiarGoogLeNet_high.Conv2d_BN(branchpool, nb_filter, (1,1), padding='same', strides=(1,1), name=None)
        """
        branch1x1 = hiarGoogLeNet_high.Conv2d_BN(x, nb_filter[0], (1,1), padding='same', strides=(1,1), name=name+'_1x1')
     
        branch3x3 = hiarGoogLeNet_high.Conv2d_BN(x, nb_filter[1], (1,1), padding='same', strides=(1,1), name=name+'_3x3_reduce')
        branch3x3 = hiarGoogLeNet_high.Conv2d_BN(branch3x3, nb_filter[2],(3,3), padding='same', strides=(1,1), name=name+'_3x3')
     
        branch5x5 = hiarGoogLeNet_high.Conv2d_BN(x, nb_filter[3], (1,1), padding='same', strides=(1,1),name=name+'5x5_reduce')
        branch5x5 = hiarGoogLeNet_high.Conv2d_BN(branch5x5, nb_filter[4], (5,5), padding='same', strides=(1,1), name=name+'_5x5')
     
        branchpool = MaxPooling2D(pool_size=(3,3), strides=(1,1), padding='same')(x)
        branchpool = hiarGoogLeNet_high.Conv2d_BN(branchpool, nb_filter[5], (1,1), padding='same', strides=(1,1), name=name+'_pool_proj')
    ...
    def build(width, height, depth, classes, pooling_regions = [1, 3], weights="imagenet"):
        ...
        x = hiarGoogLeNet_high.Conv2d_BN(inpt, 64, (7,7), strides=(2,2), padding='same', name="conv1_7x7_s2")
        x = MaxPooling2D(pool_size=(3,3), strides=(2,2), padding='same')(x)
        x = hiarGoogLeNet_high.Conv2d_BN(x, 192, (3,3), strides=(1,1), padding='same', name="conv2_3x3")
        x = MaxPooling2D(pool_size=(3,3), strides=(2,2), padding='same')(x)
        """
        x = hiarGoogLeNet.Inception(x, 64, name="inception_3a")#256
        x = hiarGoogLeNet.Inception(x, 120, name="inception_3b")#480
        """
        x = hiarGoogLeNet_high.Inception(x, [64,96,128,16,32,32], name="inception_3a")#256
        x = hiarGoogLeNet_high.Inception(x, [128,128,192,32,96,64], name="inception_3b")#480
        x = MaxPooling2D(pool_size=(3,3), strides=(2,2), padding='same')(x)
        """
        ...
        """
        x = hiarGoogLeNet_high.Inception(x, [192,96,208,16,48,64], name="inception_4a")#512
        ...
        x = hiarGoogLeNet_high.Inception(x, [160,112,224,24,64,64], name="inception_4b")
        x = hiarGoogLeNet_high.Inception(x, [128,128,256,24,64,64], name="inception_4c")
        x = hiarGoogLeNet_high.Inception(x, [112,144,288,32,64,64], name="inception_4d")#528
        ...
        x = hiarGoogLeNet_high.Inception(x, [256,160,320,32,128,128], name="inception_4e")#832
        x = MaxPooling2D(pool_size=(3,3), strides=(2,2), padding='same')(x)
        """
        x = hiarGoogLeNet.Inception(x, 208, name="inception_5a")
        x = hiarGoogLeNet.Inception(x, 256, name="inception_5b")#1024
        """
        x = hiarGoogLeNet_high.Inception(x, [256,160,320,32,128,128], name="inception_5a")
        x = hiarGoogLeNet_high.Inception(x, [384,192,384,48,128,128], name="inception_5b")#1024
...
if __name__ == "__main__":
    ...
    model = hiarGoogLeNet_high.build(160, 75, 3, [10, 20, 30])#因为googleNet默认输入32*32的图片
