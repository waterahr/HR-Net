...
from keras.layers import Input, merge, Dropout, Dense, Flatten, Activation, Conv2D, concatenate, GlobalAveragePooling2D
...
def Inception_v4(height, width, depth, nb_classes, load_weights=True):
    '''
    ...
    # Output
    out = Dense(units=nb_classes, activation='sigmoid', name='dense_classes')(x)
...
if __name__ == "__main__":
    ...
    inception_v4 = Inception_v4(299, 299, 3, 1000, load_weights=True)
