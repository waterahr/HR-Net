"""
python train_berk_hiarchical.py -m hiarBayesGoogLeNet -c 9 -g 1 -b 32
"""
...
if __name__ == "__main__":
    ...
    monitor = 'val_loss'
    if args.model == "hiarGoogLeNetSPP":
        model_dir = 'hiarGoogLeNetSPP_berk'
    elif args.model == "hiarGoogLeNetWAM":
        model_dir = 'hiarGoogLeNetWAM_berk'
    elif args.model == "hiarGoogLeNet":
        model_dir = 'hiarGoogLeNet_berk'
    elif args.model == "hiarBayesGoogLeNet":
        model_dir = 'hiarBayesGoogLeNet_berk'
        save_name = 'binary9_multi'#_loss2_ifelse
    elif args.model == "hiarGoogLeNet_high":
        model_dir = 'hiarGoogLeNet_berk'
